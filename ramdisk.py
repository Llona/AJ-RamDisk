...
def create_ramdrive(driver_name):
    ...
    fpath = sys.path[0] + '\Extra Tools\ImDisk Portable\\'

    cmd_str = 'sc create AWEAlloc binPath= "'+fpath + 'awealloc.sys" DisplayName= "AWE Memory Allocation Driver" Type= kernel Start= demand'
    print(cmd_str)
    os.system(cmd_str)
